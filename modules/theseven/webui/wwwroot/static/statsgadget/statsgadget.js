        ...
        function refresh()
        {
            ...
            mod.csc.request("statsgadget", "getallstats", {}, function(data)
            {
                ...
                var workerTable = makeTable(data["workers"],
                {
                    ...
                    "avgmhps": {210: averageMHpsDefinition},
                    "ghashes": {220: gHashesTotalDefinition},
                ...
                var blockchainTable = makeTable(data["blockchains"],
                {
                    ...
                    "jobsaccepted": {200: {"title": "Blocks", "renderer": intRenderer}, 210: makePerHourDefinition("Blocks per hour", 2)},
